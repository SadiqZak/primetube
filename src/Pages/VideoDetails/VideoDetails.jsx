    ...
    <div className="video-container flex">
      <div className="sidebar-single">
        <div className="sidebar-wrap-single">
          ...
          >
            <div
              className={`sidebar-child-single ${state.sidebarState === "home" && "selected"
                }`}
            >
          ...
          >
            <div
              className={`sidebar-child-single ${state.sidebarState === "Playlist" && "selected"
                }`}
            >
          ...
          >
            <div
              className={`sidebar-child-single ${state.sidebarState === "Liked Videos" && "selected"
                }`}
            >
          ...
          >
            <div
              className={`sidebar-child-single ${state.sidebarState === "Watch Later" && "selected"
                }`}
            >
          ...
          >
            <div
              className={`sidebar-child-single ${state.sidebarState === "History" && "selected"
                }`}
            >
      ...
      <div className="color-primary recommended-videos-single">
        <div className="video-container-wrapper">
          <div className="video-header-container">
            ...
            ></iframe>
            <div>
              <div className="video-play-footer-child">
                ...
                <div className="video-footer-right">
                  <div
                    ...
                    className={`chips-single chips-vid ${checkLiked() && "selected"
                      }`}
                  >
                    {checkLiked() && (
                      <>
                  ...
                  <div
                    ...
                    className={`chips-single chips-vid ${checkWatched() && "selected"
                      }`}
                  >
                    <span className="material-icons wd-single-fc-1">
                  ...
                  <div
                    ...
                    className={`chips-single chips-vid ${clickedPlaylist && "selected"
                      }`}
                  >
                    <span className="material-icons wd-single-fc-1">
                      playlist_play
              ...
              <div className="comments-container">
                  <div className="comments-count">{`2 Comments`}</div>
                  <div className="comments-input-container">
                    <div className="comments-avatar">A</div>
                    <input type="text" className="comments-input" placeholder="Add a comment" />
                  </div>
